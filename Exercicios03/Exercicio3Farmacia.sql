...
insert into tb_produtos(nome, datacadastro, quantidade, preco, categoria_id) 
values("RED BULL", current_date(), 100, 10.90, 5);

insert into tb_produtos(nome, datacadastro, quantidade, preco, categoria_id) 
values("Cobasi", current_date(), 100, 528.00, 1);

insert into tb_produtos(nome, datacadastro, quantidade, preco, categoria_id) 
values("CLORIDRATO DE TERBINAFINA ", current_date(), 100, 70.90, 1);

insert into tb_produtos(nome, datacadastro, quantidade, preco, categoria_id) 
values("TNT ", current_date(), 100, 7.90, 5);
